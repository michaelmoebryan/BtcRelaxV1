...
$_MYSESSION_CONF['DB_DATABASE']     =   'Ident';             //DB Name
$_MYSESSION_CONF['DB_PASSWORD']     =   'ident';             //MySql password
$_MYSESSION_CONF['DB_SERVER']       =   'dev.btcrelax.xyz';        //MySql server
$_MYSESSION_CONF['DB_USERNAME']     =   'ident';             //MySql user
#Section 1.2: Table and columns name
$_MYSESSION_CONF['TB_NAME_SESSION'] =   'Sessions';       //Table name
$_MYSESSION_CONF['SID']             =   'sid';
$_MYSESSION_CONF['EXP']             =   'expires';
$_MYSESSION_CONF['FEXP']            =   'forced_expires';
$_MYSESSION_CONF['UA']              =   'ua';
$_MYSESSION_CONF['TB_NAME_VALUE']   =   'SessionVars';       //Table name
...
$_MYSESSION_CONF['SESSION_VAR_NAME']=   'JAHSESSION';      //Session variable name - You will use this name to propagate session (like PHPSESSID)
