<?php
	...
	final class BookmarkDao extends \BtcRelax\BaseDao
	{
			...
			return $result;
			   ...
			   //TODO: Revork for bookmark entity  
				...
				$sql = 'SELECT IdBookmark, CreateDate, IdOrder, Quantity, EndDate,Latitude, Longitude, Link, Description, RegionTitle,  '
                                        . 'CustomPrice, PriceCurrency , AdvertiseTitle, UnlockDate  , State, IdDroper , TargetAddress   '
		...
		public function findById($id) {
			$row = parent::query(sprintf("SELECT IdBookmark, CreateDate, IdOrder, Quantity, EndDate,Latitude, Longitude, Link, Description, RegionTitle,  CustomPrice, PriceCurrency , AdvertiseTitle, UnlockDate  , State, IdDroper, TargetAddress    "
